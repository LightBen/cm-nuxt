...
.page-category {
  ...
  &[id*="hazanout"] .page-title-container {
    background-image: url('~assets/img/banner/constantine-orchestre.jpg');
  ...
  &[id*="cuisine"] .page-title-container {
    background-image: url('~assets/img/banner/couscous.jpg');
  }

  &[id*="articles"] .page-title-container {
    background-image: url('~assets/img/banner/books-shelf.jpg');
  }
}
...
/* Default card images */
.card-img {
  background-image: url('~assets/img/thumbnail/default-thumbnail-logo.jpg');
}
...
.list .card-img {
  background-image: url('~assets/img/thumbnail/default-thumbnail-logo.jpg') !important;
}
